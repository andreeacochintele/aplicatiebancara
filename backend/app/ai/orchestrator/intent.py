...
_SYSTEM_PROMPT = (
    ...
    "early loan repayment, repay a credit card balance, create/generate a credit card, or create a wallet/current account (e.g. 'trimite 100 "
    "lei lui Alex', 'send 50 RON to Maria', 'pay my loan installment', "
    "'ramburseaza 500 RON la credit', 'pay my credit card', 'generate a gold credit card', 'create a EUR wallet'). NOT a how-to "
