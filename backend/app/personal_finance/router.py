"""Placeholder router for the personal_finance module.
...
router = APIRouter(prefix="/personal_finance", tags=["personal_finance"])
...
def not_implemented() -> dict:
    raise HTTPException(
        ...
        detail="'personal_finance' module is not implemented yet (Phase 1 skeleton only)",
    )
