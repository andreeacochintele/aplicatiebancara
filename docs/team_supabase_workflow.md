...
> Written 2026-08-19. The process in sections 1-3 and 5-9 still holds. Section
> 4 lists the extra SQL that mattered back then, when the newest migration was
> 0013; check `supabase/sql/` and `backend/migrations/versions/` for what is
> outstanding today rather than treating that list as complete.
